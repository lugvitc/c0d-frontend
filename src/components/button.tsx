  ...
  "px-6 py-3 font-orbitron text-lg font-bold rounded-[16px] transition-all",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border border-gray-400 border-2 text-gray-400 bg-transparent hover:border-red-500 hover:text-red-500 hover:shadow-[inset_0_0_15px_#FF000080,0_0_15px_#FF000040,0_0_40px_#FF000040,0_0_60px_#FF000020] hover:brightness-125 hover:[text-shadow:_0_0_10px_#FF000080,0_0_15px_#FF000040]",
        tertiary:
...
const Button = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(
  ({ text, className, variant = "primary", ...other }, ref) => {
    const commonProps = {
      ref,
